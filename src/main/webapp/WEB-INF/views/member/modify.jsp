					...
					<form role="form" action="register" method="post">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input type="text" name="username" class="form-control" value="${member.username }" placeholder="ex) 홍길동">
							</div>
							<div class="form-group">
								<label>생년월일<span style="color:red;"> * </span></label>
								<input type="text" name="birthday" class="form-control" value="${member.birthday }" placeholder="ex) 20200504">
							</div>
							<div class="form-group">
